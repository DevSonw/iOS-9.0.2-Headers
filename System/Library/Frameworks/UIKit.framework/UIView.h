...
@class UIBezierPath, UITraitCollection, NSMutableArray, CALayer, NSArray, UIViewController, NSString, UIColor, UILayoutGuide, NSISVariable, NSISEngine, UIPresentationController, CABasicAnimation, NAUITextStyleDescriptor, MKMapView, MPArtworkCatalog, CNContactStyle, UIKBRenderConfig, _UITouchForceObservable, NSLayoutXAxisAnchor, NSLayoutYAxisAnchor, NSLayoutDimension;
